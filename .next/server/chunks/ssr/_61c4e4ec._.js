...
const likeVideo = async (videoId)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`/videos/${videoId}/likes`);
        return response.data;
    } catch (error) {
...
const unlikeVideo = async (videoId)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/videos/${videoId}/likes`);
        return response.data;
    } catch (error) {
...
"[project]/src/app/profile/[userId]/page.jsx [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
//# sourceMappingURL=_61c4e4ec._.js.map