(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_2bc0654a._.js", {
...
const UploadPage = ()=>{
    ...
    const handleVideoChange = (e)=>{
        ...
        if (!file.type.startsWith('video/')) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Please select a video file');
            return;
        }
        if (file.size > 100 * 1024 * 1024) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('File size too large (max 100MB)');
            return;
        }
        setVideoFile(file);
    ...
    const handleThumbnailChange = (e)=>{
        ...
        if (!file.type.startsWith('image/')) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Please select an image file for the thumbnail');
            return;
        }
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        if (!videoFile) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Please select a video to upload');
            return;
        }
        if (!caption.trim()) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Please add a caption');
            return;
        }
        try {
            setUploading(true);
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$config$2e$js$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/videos', formData, {
                headers: {
...
//# sourceMappingURL=src_2bc0654a._.js.map