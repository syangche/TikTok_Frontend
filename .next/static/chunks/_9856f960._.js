(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_9856f960._.js", {
...
const updateUser = async (userId, userData)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`/users/${userId}`, userData);
        return response.data;
    } catch (error) {
...
const likeVideo = async (videoId)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`/videos/${videoId}/likes`);
        return response.data;
    } catch (error) {
...
const unlikeVideo = async (videoId)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/videos/${videoId}/likes`);
        return response.data;
    } catch (error) {
...
"[project]/src/app/profile/[userId]/page.jsx [app-client] (ecmascript)": (function(__turbopack_context__) {

var { g: global, d: __dirname, k: __turbopack_refresh__, m: module, e: exports } = __turbopack_context__;
{
const e = new Error(`Could not parse module '[project]/src/app/profile/[userId]/page.jsx'
...
//# sourceMappingURL=_9856f960._.js.map